...
class UseAccountSubjectsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('use_account_subjects')->insert([
            ...
            ['user_id' => 1, 'account_subject_id' => 20, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ...
            ['user_id' => 1, 'account_subject_id' => 36, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['user_id' => 1, 'account_subject_id' => 37, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['user_id' => 1, 'account_subject_id' => 38, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['user_id' => 1, 'account_subject_id' => 39, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['user_id' => 1, 'account_subject_id' => 40, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['user_id' => 1, 'account_subject_id' => 41, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['user_id' => 1, 'account_subject_id' => 47, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
